...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    const char *vpndata = "com/antest1/kcasniffer/KcaVpnData";
...
Java_com_antest1_kcasniffer_KcaVpnService_jni_1init(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_antest1_kcasniffer_KcaVpnService_jni_1start(
...
JNIEXPORT void JNICALL
Java_com_antest1_kcasniffer_KcaVpnService_jni_1stop(
...
Java_com_antest1_kcasniffer_KcaVpnService_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}

JNIEXPORT jintArray JNICALL
Java_com_antest1_kcasniffer_KcaVpnService_jni_1get_1stats(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_antest1_kcasniffer_KcaVpnService_jni_1pcap(
...
JNIEXPORT void JNICALL
Java_com_antest1_kcasniffer_KcaVpnService_jni_1socks5(JNIEnv *env, jobject instance, jstring addr_,
...
JNIEXPORT void JNICALL
Java_com_antest1_kcasniffer_KcaVpnService_jni_1done(JNIEnv *env, jobject instance) {
